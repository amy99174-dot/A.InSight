...
SOUND_WIND, SOUND_WATER, SOUND_CLANK, SOUND_CROWD, SOUND_QUIET, SOUND_LOW, SOUND_HUM, SOUND_FIRE, SOUND_SCREAM,SOUND_SCIFI_RELIC,SOUND_PALACE_HALL,SOUND_TEMPLE_INCENSE,SOUND_CRAFT_CERAMIC,SOUND_CRAFT_STONE,SOUND_CAVE_RUMBLE
二、輸出指令，讓系統播放被選擇的音效。
        ...
        if GPIO_AVAILABLE:
            try:
                self.gpio_controller = GPIOController(
                    confirm_pin=4,   # GPIO4  → Pin 7  (swapped: was right)
                    left_pin=26,     # GPIO26 → Pin 37
                    right_pin=17,    # GPIO17 → Pin 11 (swapped: was confirm)
